---
title: 'SDS M1: The Datascience Pipeline'
...
if (!require("pacman")) install.packages("pacman") # package for lading and checking packages :)
pacman::p_load(devtools, rstudioapi, tidyverse)
```
...
![The adventures of Data](https://www.dropbox.com/s/j5xgpou59lqdbq2/OSEMN.png?dl=1)
...
![You found Data](https://www.dropbox.com/s/ueywoxlx8hetxsy/data.png?dl=1)
...
![Cleaning](https://www.dropbox.com/s/3da59pzk5dp6b53/cleaning.jpg?dl=1)
...
![Modeling fun](https://www.dropbox.com/s/iqrsa4418151ofa/cleaning2.jpg?dl=1)
